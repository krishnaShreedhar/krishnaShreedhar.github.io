...
subtitle: "A2C (Advantage Actor-Critic) is a synchronous, on-policy algorithm that simultaneously learns a **policy** (the actor) and a **value function** (the critic). It extends REINFORCE by using the critic's value estimate..."
category: technical
project: rl_envs
...
output: "blogs/technical/posts/rl_envs/docs/algorithms/04_a2c.html"
---
## Concept
